...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete") {
  ...
  if (isset($conn[$dbKey])) {
    ...
    try {
      ...
      resequenceTableIds($selectedConn, 'tblclassteacher');
                                ...
                                while ($rows = $result->fetch_assoc()) {
                                  ...
                                  echo "
                                        <tr>
                                            ...
                                            <td><a href='?action=delete&Id={$rows['Id']}&dbKey=$dbKey' onclick='return PIMTAlert.confirmLink(this, \"Are you sure you want to delete this record?\")'><i class='fas fa-fw fa-trash'></i>Delete</a></td>
                                        </tr>";
                                }
                              } else {
