...
$tRow = $conn->query("SELECT photo, emailAddress FROM tblteacher WHERE Id=".(int)$_SESSION['userId'])->fetch_assoc();
$photo = $tRow['photo'] ?? '';
$email = $tRow['emailAddress'] ?? '';
$photoHtml = $photo
...
<div id="topbar">
    ...
    <div class="topbar-right">
        <span class="topbar-date"><i class="fas fa-calendar-alt" style="margin-right:5px;color:#5c6bc0"></i><?= date('D, d M Y') ?></span>
        <div class="topbar-user" id="profileTrigger">
            ...
            <div>
                ...
                <div class="topbar-role" style="color:#00b4d8">Teacher</div>
            </div>
            ...
            <div class="profile-dropdown" id="profileDropdown">
                <div class="profile-dropdown-header">
                    ...
                    <div class="profile-dropdown-info">
                        ...
                        <p style="color:#00b4d8;margin-top:2px;">Class Teacher</p>
                    </div>
                </div>
